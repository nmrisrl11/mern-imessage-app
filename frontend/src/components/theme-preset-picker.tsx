									...
									return (
										<button
											...
											className={cn(
												...
												selected ? "bg-white/10 ring-2 ring-accent ring-offset-2 ring-offset-[#2a2a2c]" : "hover:bg-white/6",
											)}
											aria-pressed={selected}
										>
											<span className="relative">
												<span className="block size-14 shrink-0 rounded-full shadow-md ring-1 ring-white/20" style={{ background: p.swatch }} />
											...
											<span className={cn("text-[11px] font-medium leading-tight", selected ? "text-white" : "text-zinc-400")}>{p.label}</span>
										</button>
									);
								})}
							</div>
