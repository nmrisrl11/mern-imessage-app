...
export function AuthCardShell({ children }: AuthCardShellProps): JSX.Element {
	return (
		<div className="relative z-10 mx-auto w-full max-w-105">
			<div className="relative">
				...
				>
					<div aria-hidden className="pointer-events-none absolute -right-24 top-0 size-56 rounded-full bg-accent/12 blur-3xl dark:bg-accent/18" />
